...
3. **Security Boundary**: Be aware that the tool restricts access to an allowed directory (defined by `POLARISAGI_KB_ALLOWED_DIR`); do not attempt to read system files or sensitive data outside of this workspace.
