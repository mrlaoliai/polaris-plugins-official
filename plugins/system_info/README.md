# PolarisAGI System Info MCP

An official Model Context Protocol (MCP) server plugin for [PolarisAGI](https://polarisagi.online/), providing cross-platform system environment and context awareness.
...
{
  "mcpServers": {
    "polarisagi-systeminfo-mcp": {
      "command": "python",
      "args": ["/path/to/polarisagi-plugins-official/plugins/system_info/src/main.py"]
    }
  }
}
```
